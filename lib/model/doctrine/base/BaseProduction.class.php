...
abstract class BaseProduction extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('matinee_performance_time', 'time', null, array(
             'type' => 'time',
             ));
        $this->hasColumn('evening_performance_time', 'time', null, array(
             'type' => 'time',
             ));
        $this->hasColumn('various_performance_times', 'boolean', null, array(
             'type' => 'boolean',
             'default' => false,
             ));
