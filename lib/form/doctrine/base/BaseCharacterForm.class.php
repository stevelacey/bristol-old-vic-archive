...
abstract class BaseCharacterForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'actor_id'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Person'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'actor_id'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Person'))),
