...
abstract class BaseProductionForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'director_id'          => new sfWidgetFormInputText(),
      'producer_id'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'director_id'          => new sfValidatorInteger(array('required' => false)),
      'producer_id'          => new sfValidatorInteger(array('required' => false)),
      'technician_id'        => new sfValidatorInteger(array('required' => false)),
      'description'          => new sfValidatorString(array('required' => false)),
      'start_at'             => new sfValidatorPass(array('required' => false)),
      'end_at'               => new sfValidatorPass(array('required' => false)),
